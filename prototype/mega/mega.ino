...
const uint8_t PINS_COIN[NUM_KEYS_COIN] = {19,20,21};

const int pricePerSong = 50;
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(2), debounceInterrupt, INPUT_PULLUP);
...
void loop() {
 ...
 if(keyNumber!=NULL && keyLetter!=NULL && balance >= pricePerSong){
